...
cron.schedule("* * * * *", () => {
	...
	axios.get("https://hexaco.herokuapp.com/api/getcameras").then(cam => {
		console.log(cam);
		axios.get("https://hexaco.herokuapp.com/api/getlastphoto").then(lp => {
			console.log(lp);
			axios
				.get("https://hexaco.herokuapp.com/api/getpalette")
				.then(pal => {
					console.log(pal);
					console.log("done");
				})
